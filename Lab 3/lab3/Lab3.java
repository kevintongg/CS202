...
public class Lab3 {
  ...
  public static void pickOption() {
    ...
    do {
      System.out.println(
          "Please enter one of the following:\n'0' to quit\n'1' to show the current schedule\n'2' to schedule a class\n'3' to add students\n'4' to register a student\n'5' to display current class information\n'6' to create a gym class");
      while (!sc.hasNextInt()) {
        sc.nextLine();
        System.out.println(
            "Invalid input! Please enter '0' to quit, '1' to show the current schedule, '2' to schedule a class, '3' to add students, '4' to register a student, '5' to display current class information, and '6' to create a gym class.");
      }
      choice = sc.nextInt();
      switch (choice) {
        case 1:
        ...
        case 5:
          ...
          break;
        case 6:
          int pickTypeOfCourse;
          do {
            System.out.println(
                "Enter one of the following options:\n'0' to quit\n'1' to add an online course\n'2' to add a group course\n'3' to add a course for individuals");
            while (!sc.hasNextInt()) {
              sc.nextLine();
              System.out.println(
                  "Invalid output! Please enter '0' to quit, '1' to add an online course, '2' to add a group course, and '3' to add a course for individuals");
            }
            pickTypeOfCourse = sc.nextInt();
            switch (pickTypeOfCourse) {
              case 1:
                OnlineCourse.askUserForInfo();
                break;
              case 2:
                GroupCourse.askUserForInfo();
                break;
              case 3:
                IndividualCourse.askUserForInfo();
                break;
            }
          } while (pickTypeOfCourse != 0);
          System.out.println("\nWe will now display course information:\n");
          System.out.println("\nOnline course information:");
          OnlineCourse.printClassInfo();
          System.out.println("\nGroup course information:");
          GroupCourse.printClassInfo();
          System.out.println("\nIndividual course information:");
          IndividualCourse.printClassInfo();
          break;
      }
    ...
    do {
      ...
      switch (choice) {
        ...
        /*
          ...
          switch (pickClass) {
            case 1:
              if (Course.students.contains(name)) {
                System.out.println("Sorry, this student has been signed up already.");
                studentRegistration();
              }
              break;
            case 2:
